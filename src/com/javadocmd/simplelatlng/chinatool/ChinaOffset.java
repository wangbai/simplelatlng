...
public final class ChinaOffset {
    ...
    private Point wgtochina_lb(int wg_flag, int wg_lng, int wg_lat,
            int wg_heit, int wg_week, int wg_tithis) {
        double x_add;
        double y_add;
        double h_add;
        double x_l;
        ...
        h_add = wg_heit;
        x_add = x_add + h_add * 0.001 + yj_sin2(wg_tithis * 0.0174532925199433)
                + random_yj();
        y_add = y_add + h_add * 0.001 + yj_sin2(wg_tithis * 0.0174532925199433)
                + random_yj();
