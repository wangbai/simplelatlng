...
public class LatLng implements Serializable {
     ...
     * 
     * @param r
     *            the random number generator to use, if you want to be specific
     *            or are creating many LatLngs at once.
     */
    ...
    /**
     * Get the internal long representation of this point's longitude in
     * degrees. Intended for library use only.
     * 
    ...
    public void setLatitudeLongitude(double latitude, double longitude) {
        ...
        if (Math.abs(this.latitude) == 90000000L) {
            // At the poles all longitudes intersect. Simplify for later
            // comparison.
            this.setLongitude(0);
        } else {
    ...
    /**
     * Returns true if this LatLng represents a polar coordinate (+/- 90 degrees
     * latitude).
     */
    ...
    public String toString() {
        return String.format(
                "(%s,%s)",
                LatLngConfig.getDegreeFormat().format(
                        LatLngConfig.longToDouble(this.latitude)),
                LatLngConfig.getDegreeFormat().format(
                        LatLngConfig.longToDouble(this.longitude)));
    }
}
