...
public class PolygonWindowTest {
    ...
    public static void main(String[] args) {
        ...
        points[1] = new LatLng(0, 1);
        points[2] = new LatLng(1, 1);
        points[3] = new LatLng(1, 0);

        System.out.println(PolygonWindow.isSimple(points));

        LatLng[] points1 = new LatLng[4];
        points1[0] = new LatLng(0, 0);
        points1[1] = new LatLng(0, 1);
        points1[2] = new LatLng(1, 0);
        points1[3] = new LatLng(1, 1);

        System.out.println(PolygonWindow.isSimple(points1));
